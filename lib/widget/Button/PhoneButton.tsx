...
export default function PhoneButton() {
    ...
    return (
        ...
        className={`bottom-10 right-3 md:right-[14%] z-50 md:bottom-[100px]  rounded-full py-3 px-4 absolute flex gap-x-3 bg-[#db5050] shadow-2xl drop-shadow-2xl text-[#2e6417] `}
         > 
