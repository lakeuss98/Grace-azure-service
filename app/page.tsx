    ...
    return (
        <div>
            ...
            <section title="Pourquoi nous ?" className="px-4 sm:px-20 md:px-[15%] py-12  ">
                <div className="flex text-3xl md:text-4xl font-bold justify-center  py-5 w-full col-span-2 ">Pourquoi nous ?</div>
                <div className="grid grid-cols-1 md:grid-cols-4 py-3 md:py-10 items-center bg-amber-100   ">
                    ...
                    </div>                    <span className="flex justify-center text-center md:text-[16px] font-semibold" >Disponibilité les soirs et les week-ends  </span>
                </div>
